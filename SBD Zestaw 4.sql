...
--XII.1
--Napisz prosty program w Transact-SQL (PL/SQL). Zadeklaruj zmienn¹, przypisz na t¹
--zmienn¹ liczbê rekordów w tabeli OSOBA (lub jakiejkolwiek innej) i wypisz uzyskany
--wynik u¿ywaj¹c instrukcji Print (T-SQL) lub dbms_output (PL/SQL), w postaci napisu np.
--"W tabeli jest 10 rekordów".

--XII.2
--U¿ywaj¹c T-SQL (PL/SQL), policz dydaktyków z tabeli DYDAKTYK. Jeœli ich liczbajest mniejsza ni¿ 16,
...
--parametrze procedury. W T_SQL przeæwicz 3 sposoby zwracania danych przez procedurê
...
--informuj¹cym o wykonanej operacji. W PL/SQL utwórz i wykorzystaj sekwencjê do
